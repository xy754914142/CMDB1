...
class Taizhang(models.Model):
    ...
    Commissioning_date = models.DateTimeField(null=True, blank=True, verbose_name='启用日期')
    ...
    calibration_time = models.DateTimeField(null=True, blank=True, verbose_name='检定日期')
    expire_time = models.DateTimeField(null=True, blank=True, verbose_name='到期日期')
